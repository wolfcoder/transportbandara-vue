<template>
  <section id="airport-transfer" class="airport-transfer max-w-6xl mx-auto py-8 md:py-16 lg:py-24 ">
    <h2 class="underline uppercase text-gray-800 mb-4 md:pl-0 pl-4">Airport Transfer</h2>
    <div class="bg-gray-100 p-5 rounded-lg">
      <form action="#" method="POST" class=" grid grid-cols-1 gap-y-6 sm:grid-cols-5 sm:gap-x-8">
        <div>
          <label for="dari" class="block text-sm font-medium text-gray-600">Dari</label>
          <div class="mt-1">
            <input readonly type="text" name=harga id=harga autocomplete="" value="Bandara Ngurah Rai"
        ...
        <div>
          <label for="tujuan" class="block text-sm font-medium text-gray-600">Tujuan</label>
          <div class="mt-1">
            <select @change="onDestinationChange($event)" type="text" name="tujuan" id="tujuan" autocomplete=""
                    class="block w-full rounded-md border-gray-300 py-2 px-4 text-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
        ...
        <div>
          <label for="tujuan" class="block text-sm font-medium text-gray-600">Kendaraan</label>
          <div class="mt-1">
            <select @change="onVehicleChange($event)" type="text" name="tujuan" id="tujuan" autocomplete=""
                    class="block w-full rounded-md border-gray-300 py-2 px-4 text-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
              <option :value="index" v-for="(item,index) in vehicle" :key="index">
                {{ item.kendaraan }}
              </option>
            </select>
          </div>
        ...
        <div>
          ...
          <div class="mt-1">
            <input readonly type="text" name=harga id=harga autocomplete="" :value="price"
                   class="block w-full rounded-md border-gray-300 py-2 px-4 text-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
          </div>
        </div>
        <div>
          <label for="button" class="block text-sm font-medium text-transparent">.</label>
          <div class="mt-1">
            <button type="submit"
...
export default {
  data() {
    return {
      post: [{"tujuan": "Kuta/Legian",
        "pilihan_repeater": [{"kendaraan": "Avanza/Xenia", "harga": 150000}, {
          "kendaraan": "Inova Reborn",
          "harga": 300000
        }, {"kendaraan": "Haice Commuter", "harga": 400000}]
      }, {"tujuan": "Seminyak",
        "pilihan_repeater": [{"kendaraan": "Avanza/Xenia", "harga": 200000}, {
          "kendaraan": "Inova Reborn",
          "harga": 300000
        }, {"kendaraan": "Haice Commuter", "harga": 400000}]
      }, {"tujuan": "Canggu",
        "pilihan_repeater": [{"kendaraan": "Avanza/Xenia", "harga": 249996}, {
          "kendaraan": "Inova Reborn",
          "harga": 350000
        }, {"kendaraan": "Haice Commuter", "harga": 400000}]
      }],
      price: null,
      vehicle: [{kendaraan: "Avansa/Xenia", harga: 150000}, {
        kendaraan: "Inova Reborn",
        harga: 300000
      }, {kendaraan: "Haice Commuter", harga: 400000}]
    }
