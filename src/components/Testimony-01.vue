<template>
  <section
    id="testimony-01"
    class="max-w-6xl mx-auto py-8 md:my-16 lg:my-24 text-center"
  >
    <div
    ...
    <h2 class="text-2xl md:text-4xl font-semibold text-gray-800 mb-6 md:mb-5">
      Disukai Oleh Banyak Pelanggan
    </h2>
    <p class="mb-12 max-w-4xl mx-auto text-gray-400 px-4 md:px-0">
      Lebih dari 100 Pelanggan kami tiap tahun liburan di Bali bersama
      Transportbandara, datang dari berbagai kota di Indonesia dan bahkan manca
      negara, tamu dari Australia yang sering banyak datang mengunjungi Bali,
      mereka liburan selalu bersama kami. Selanjutnya mungkin Anda?
    </p>
    ...
    <div class="relative w-full overflow-x-auto pb-4">
      ...
      >
        <li>
          <figure
            class="relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10 w-[240px] md:w-[340px] h-auto"
          >
            <svg
              aria-hidden="true"
              width="105"
            ...
            <blockquote class="relative">
              <p class="pb-0 text-lg tracking-tight text-slate-900">
            ...
            >
              <div>
                <div class="font-SourceSerifPro text-base text-slate-900">
                  Sheryl Berge
                </div>
              ...
              <div class="overflow-hidden rounded-full bg-slate-50">
                <img
                  alt=""
                  src="https://pixelmedia.id/wp-content/themes/wp-pixelmedia/public/images/optimasi-wp/avatars/avatar-2.png"
                  width="56"
                  height="56"
          ...
          >
            ...
            <blockquote class="relative">
              <p class="pb-0 text-lg tracking-tight text-slate-900">
                ...
                trouble right now and they are saying it has something to do
                with my books. Please get back to me right away.
              </p>
            </blockquote>
            <figcaption
              class="relative mt-6 flex items-center justify-between border-t border-slate-100 pt-6"
            >
              ...
              <div class="overflow-hidden rounded-full bg-slate-50">
                <img
                  alt=""
                  src="https://pixelmedia.id/wp-content/themes/wp-pixelmedia/public/images/optimasi-wp/avatars/avatar-1.png"
                  width="56"
                  height="56"
                  class="h-14 w-14 object-cover"
                  loading="lazy"
        ...
        <li>
          ...
          >
            ...
            <blockquote class="relative">
              <p class="pb-0 text-lg tracking-tight text-slate-900">
                The best part about TaxPal is every time I pay my employees, my
            ...
            >
              ...
              >
                ...
                <div class="overflow-hidden rounded-full bg-slate-50">
                  <img
                    alt=""
                    src="https://pixelmedia.id/wp-content/themes/wp-pixelmedia/public/images/optimasi-wp/avatars/avatar-3.png"
                    width="56"
                    height="56"
                    class="h-14 w-14 object-cover"
                    loading="lazy"
            ...
            >
              ...
              >
                ...
                <div class="overflow-hidden rounded-full bg-slate-50">
                  <img
                    alt=""
                    src="https://pixelmedia.id/wp-content/themes/wp-pixelmedia/public/images/optimasi-wp/avatars/avatar-4.png"
                    width="56"
                    height="56"
                    class="h-14 w-14 object-cover"
                    loading="lazy"
            ...
            >
              ...
              >
                ...
                <div class="overflow-hidden rounded-full bg-slate-50">
                  <img
                    alt=""
                    src="https://pixelmedia.id/wp-content/themes/wp-pixelmedia/public/images/optimasi-wp/avatars/avatar-5.png"
                    width="56"
                    height="56"
                    decoding="async"
                    data-nimg="future"
