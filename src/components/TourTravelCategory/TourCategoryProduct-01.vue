<template>
  <section class="max-w-6xl mx-auto py-8 md:my-16 lg:my-24 text-center">
    <div
      class="bg-brandPrimary text-white py-1 px-5 rounded-full inline-block text-sm mb-3"
    >
      Tour Tempat Wisata
    </div>
...
<script>
import TourCategoryProduct01Item from './TourCategoryProduct-01-item.vue';
export default {
  name: 'TourPage',
  components: { TourCategoryProduct01Item },
};
</script>
