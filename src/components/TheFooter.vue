<template>
<section id="footer-01" class=" bg-brandPrimary md:mt-16 lg:mt-24 text-white p-4 sm:p-0">
     <div class=" max-w-6xl mx-auto py-8 md:flex flex-rows gap-16 ">
        <div class="w-full md:max-w-[305px] mb-12 md:mb-0">
            <h3 class="font-Inter font-extrabold mb-6 text-lg">TransportBandara</h3>
            <p class="mb-6">Liburan di Bali lebih menyenangkan bersama kami sejak dari bandara.
    </p>
            <ul>
